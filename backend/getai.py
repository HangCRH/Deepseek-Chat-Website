...
model_list = [
    {"name": "deepseek-v4-flash-chat", "display_name": "DeepSeek V4 Flash 非深度思考"},
    {
        ...
        "display_name": "DeepSeek V4 Flash 深度思考-low",
    },
    {
        "name": "deepseek-v4-flash-high",
        "display_name": "DeepSeek V4 Flash 深度思考-high",
    },
...
async def get_response(use_model, user_message):
    ...
    final_question = (
        user_message[-1]["content"] if user_message else "No question provided"
    )
